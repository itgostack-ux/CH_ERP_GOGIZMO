  ...
  var DashboardWorkspace = class {
    ...
    _render_recent(activities) {
      ...
      for (const act of activities) {
        const icon = act.type === "Material Request" ? "fa-clipboard" : act.type === "Stock Entry" ? "fa-truck" : "fa-file-text-o";
  ...
  var TransfersWorkspace = class {
    ...
    _render_list() {
      ...
      for (const tr of this._transfers) {
        ...
        const mr_link = tr.material_request ? `<span class="ops-transfer-mr">${__("MR")}: ${frappe.utils.escape_html(tr.material_request)}</span>` : "";
        html += `
...
//# sourceMappingURL=operations_hub.bundle.5I7BZLPL.js.map
